...
INSERT INTO products (product_id, display_name, category, base_sell_price) VALUES
    ('wheat',  'Пшеница',   'RAW',       5),
    ('corn',   'Кукуруза',  'RAW',       6),
...
INSERT INTO plants (
    plant_id, product_id, display_name,
    growth_time_sec, water_decay_per_tick, initial_water_level
) VALUES
    ('wheat',  'wheat',  'Пшеница',   120, 2, 50),
...
INSERT INTO animals (
    animal_id, product_id, display_name,
    feed_product_id, production_interval_sec
) VALUES
    ('cow', 'milk', 'Корова', 'feed', 180);

-- ---------------------------------------------------------------------------
-- Buildings — each factory has its own time_coef for price formula
-- ---------------------------------------------------------------------------

INSERT INTO buildings (building_type, display_name, time_coef) VALUES
    ('BAKERY', 'Хлебопекарня', 2.0),
    ('DAIRY',  'Молочный',     1.5),
...
INSERT INTO recipes (
    recipe_id, building_type, output_product_id,
    production_time_sec, price_override
) VALUES
    ('bread', 'BAKERY', 'bread', 30, NULL),
...
INSERT INTO random_events (event_id, display_name, effect_type, duration_ticks, severity) VALUES
    ('drought',      'Засуха',        'DROUGHT',      15, 1.0),
...
INSERT INTO sabotages (sabotage_id, display_name, sabotage_type, cost_bestiki, is_hidden) VALUES
    ('mine_tile',     'Мина на клетке',           'MINE',           25, 1),
...
INSERT INTO countermeasures (
    countermeasure_id, display_name, countermeasure_type,
    cost_bestiki, targets_sabotage_id
) VALUES
    ('vaccine',      'Вакцинация',   'PREVENTIVE', 15, 'spread_disease'),
